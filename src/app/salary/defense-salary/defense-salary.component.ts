...
@Component({
  selector: 'app-defense-salary',
  templateUrl: './defense-salary.component.html',
  styleUrls: ['./defense-salary.component.css']
})
export class DefenseSalaryComponent implements OnInit, OnDestroy {
