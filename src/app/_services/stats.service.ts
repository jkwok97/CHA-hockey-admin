...
export class StatsService {
  ...
  getActivePlayersByTeam(name: string, bool:string, season: string, seasonType: string) {
  ...
  getActiveGoaliesByTeam(name: string, bool:string, season: string, seasonType: string) {
